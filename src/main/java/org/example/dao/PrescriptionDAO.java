...
public class PrescriptionDAO {
    ...
    public void addPrescriptionWithItems(Prescription prescription, List<PrescriptionItem> items) throws SQLException {
        ...
        try {
            ...
            // Insert prescription - handle missing columns gracefully
            String prescriptionSQL = "INSERT INTO prescriptions (patient_id, doctor_id, prescription_date, diagnosis, notes) VALUES (?, ?, ?, ?, ?)";
            try (PreparedStatement prescriptionStmt = conn.prepareStatement(prescriptionSQL, Statement.RETURN_GENERATED_KEYS)) {
                        ...
                        if (generatedKeys.next()) {
                            ...
                            try (PreparedStatement itemStmt = conn.prepareStatement(itemSQL)) {
                                for (PrescriptionItem item : items) {
                                    ...
                                    itemStmt.setInt(1, item.getPrescriptionId());
    ...
    public Prescription getPrescription(int id) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                prescription.setDoctorName("Dr. " + rs.getString("doctor_first_name") + " " + rs.getString("doctor_last_name"));
                return prescription;
            }
        }
        return null;
